...
export async function PUT(req: Request) {
  try {
    ...
    // share the same config, so they bust together.
    ...
    // website-row/products entries on exactly this tag. Next 16 signature:
    // the 'max' profile expires the tag immediately.
