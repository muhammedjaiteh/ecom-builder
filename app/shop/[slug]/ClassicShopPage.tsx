...
// ClassicShopPage — the classic boutique, byte-identical to the historical
// app/shop/[slug]/page.tsx client page. Pillar 1 moved the component here so
// page.tsx could become the SERVER bridge (published-site shops 307 to their
// /site storefront; everyone else renders this classic page untouched). The
// only change in this file: `slug` arrives as a plain prop (the server page
// already awaited params) instead of use(params).
...
export default function ClassicShopPage({ slug }: { slug: string }) {
  ...
  // Gold family = flagship + legacy advanced (Blind Spot fix — the top payer
  // historically rendered with no crown halo at all).
